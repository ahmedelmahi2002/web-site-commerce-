        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item d-none d-lg-flex">
              <a class="nav-link" href="{{ route('etats.create') }}">
                <span class="btn btn-primary">+ Create new etats </span>
              </a>
            </li>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Update Button -->
                        <a href="{{ route('etats.edit', $etat->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ route('etats.show', $etat->id) }}" class="btn btn-info">Show</a>
                        <!-- Delete Button -->
