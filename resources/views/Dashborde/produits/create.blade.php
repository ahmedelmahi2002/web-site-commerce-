  ...
  <div class="formbold-main-wrapper">
    ...
    <div class="formbold-form-wrapper">
      <form action="{{ route('produits.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="formbold-mb-5">
          <label for="sous_famille_id" class="formbold-form-label">
              Libelle:
          </label>
          <select name="sous_famille_id" id="sous_famille_id" class="formbold-form-input">
            <option value="">Select sousFamille</option>
        ...
        <div>
          <button type="submit" class="formbold-btn w-full">Create produits</button>
        </div>
      </form>
    </div>
  </div>
