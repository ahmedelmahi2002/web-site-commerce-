        ...
        <div class="formbold-form-wrapper">
            <form action="{{ route('sous_familles.update', $sous_famille->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="formbold-mb-5">
                    ...
                    <input type="text" name="libelle" id="libelle" required value="{{ $sous_famille->libelle }}" class="formbold-form-input" />
                </div>
                ...
                <div class="formbold-mb-5">
                    ...
                    <select name="famille_id" id="famille_id" class="formbold-form-input">
                        <option value="">Select famille</option>
                        @foreach ($familles as $famille)
                            <option value="{{ $famille->id }}" {{ $famille->id == $sous_famille->famille_id ? 'selected' : '' }}>
                                {{ $famille->libelle }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    <button type="submit" class="formbold-btn w-full">Update Sous famille</button>
                </div>
            </form>
        </div>
    </div>
